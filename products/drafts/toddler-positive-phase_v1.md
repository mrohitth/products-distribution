...
Three parts to every redirection:
1. The instruction (what you want them to do)
2. The reason (when appropriate and brief)
3. The alternative (what they can do instead)
...
- Heavy furniture is anchored to the wall
- No small objects that could be swallowed
- Nothing toxic within reach
- One low shelf with toys the toddler can access independently
...
Outside the yes space, give your toddler choices that are both acceptable to you:
- "Do you want to wear the red shirt or the blue shirt?"
- "Do you want to walk to the car or be carried?"
- "Do you want to hold my hand or the stroller strap?"
...
You can give them the language:
- "You are angry that I took that away."
- "You wanted to keep playing."
- "You are frustrated that we have to leave the playground."
